...
public class ArrayTwoTasksTest {
 ...
 @Test
    ...
    @Test
    public void testNo14TestExpectedFalseThree() {
        ArrayTwoTasks arrayTwoTasks = new ArrayTwoTasks();
        int [] testedNums = {1,3, 4};
        boolean result=arrayTwoTasks.no14(testedNums);
        Assert.assertEquals(result,false);
    ...
    @Test
    public void testNo14TestExpectedFalseFour() {
        ArrayTwoTasks arrayTwoTasks = new ArrayTwoTasks();
        int [] testedNums = {1,3, 4,5,6};
        boolean result=arrayTwoTasks.no14(testedNums);
        Assert.assertEquals(result,false);

    }
    @Test
    public void testNo14TestExpectedFalseFive() {
        ArrayTwoTasks arrayTwoTasks = new ArrayTwoTasks();
        int [] testedNums = {1,3, 4,5,6,7};
        boolean result=arrayTwoTasks.no14(testedNums);
        Assert.assertEquals(result,false);
